...
const Carousel = () => {
  ...
  return (
    <div
      className="max-w-[1240px] mx-auto px-4 py-16 relative flex 
    justify-center items-center overflow-hidden"
    >
      <BsArrowLeftSquareFill
        onClick={prevSlide}
        className="absolute top-[50%] left-8 text-3xl text-white cursor-pointer"
      />
      <BsArrowRightSquareFill
        onClick={nextSlide}
        className="absolute top-[50%] right-8 text-3xl text-white cursor-pointer"
      />
